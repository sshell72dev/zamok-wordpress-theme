        ...
        <div class="items-wrap">
            ...
            <div class="item-wrap">
                <div class="item-tile-info">
                    <?php if ($item['icon']): ?>
                    <div class="elm-ico">
                        <img src="<?php echo esc_url($item['icon']['url']); ?>" alt="<?php echo esc_attr($item['icon']['alt'] ?: $item['text']); ?>">
                    </div>
    ...
    <div class="bg-box section-inner">
        ...
        <div class="action-box">
            <div class="info-inner-wrap">
                <div class="section-title h1-title title-small-d"><?php echo get_field('action_title') ?: get_field('action_title', 'option') ?: 'Чтобы вызвать мастера открыть машину звоните по телефону'; ?></div>
                ...
                <div class="section-title h1-title title-small-d"><?php echo get_field('action_subtitle') ?: get_field('action_subtitle', 'option') ?: 'приедем через 15-20 минут'; ?></div>
                <?php 
                ...
                <?php endif; ?>
                <div class="elm-info"><?php echo get_field('action_info') ?: get_field('action_info', 'option') ?: 'Все работы по вскрытию автомобиля производятся при предъявлении документов на транспортное средство'; ?></div>
            </div>
        </div>
        <!--/action-box-->
    </div>
                        ...
                        <div class="sl-wrap swiper-slide">
                            <div class="item-tile-service">
                                ...
                                <div class="tile-info-wrap">
                                    ...
                                    <?php 
                                    $service_desc = get_field('service_description', $service->ID);
                                    if ($service_desc) {
                                        echo $service_desc;
                                    } else {
                                        echo get_the_excerpt($service->ID);
                                    }
                                    ?>
                                </div>
